# Spec delta: recipe-overrides-runtime
...
(Previously: overrides lived under `.recipe/{recipe-id}/overrides/`.)
...
(Previously: overrides lived under `.recipe/{recipe-id}/overrides/templates/`.)
