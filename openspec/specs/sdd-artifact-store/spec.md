# sdd-artifact-store Specification

## Purpose

Definir los modos declarativos de almacenamiento de artefactos SDD (`artifact_store`) y su interacción con OpenSpec en disco.
