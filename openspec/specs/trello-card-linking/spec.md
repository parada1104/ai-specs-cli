# trello-card-linking Specification

## Purpose

Enable agents to link OpenSpec changes to Trello cards, either by posting comments on existing cards or creating new cards from bundled templates.
