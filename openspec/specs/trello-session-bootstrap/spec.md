# trello-session-bootstrap Specification

## Purpose

Enable agents to read the Trello board bootstrap marker and detect the active card at session start, feeding results into the 3-level consensus check.
